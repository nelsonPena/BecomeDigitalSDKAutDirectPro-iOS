...
<<<<<<< HEAD:BecomeDigitalV.xcframework/ios-arm64/BecomeDigitalV.framework/Headers/BecomeDigitalV-Swift.h
...
#ifndef BDIDENTITYVERIFICATION_SWIFT_H
#define BDIDENTITYVERIFICATION_SWIFT_H
>>>>>>> release_finger:BDIdentityVerification.xcframework/ios-arm64/BDIdentityVerification.framework/Headers/BDIdentityVerification-Swift.h
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BDIdentityVerification",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
